...
{
    public interface ICurtains_Scenes_Edit
    {
        ...
        void Dig_Reserved_Out1(Curtains_Scenes_EditBoolInputSigDelegate callback);
        void Scene0_CurrentName(Curtains_Scenes_EditStringInputSigDelegate callback);
        void Scene1_CurrentName(Curtains_Scenes_EditStringInputSigDelegate callback);
        void Scene2_CurrentName(Curtains_Scenes_EditStringInputSigDelegate callback);

    }

    public delegate void Curtains_Scenes_EditBoolInputSigDelegate(BoolInputSig boolInputSig, ICurtains_Scenes_Edit curtains_Scenes_Edit);
    public delegate void Curtains_Scenes_EditStringInputSigDelegate(StringInputSig stringInputSig, ICurtains_Scenes_Edit curtains_Scenes_Edit);

    internal class Curtains_Scenes_Edit : ICurtains_Scenes_Edit, IDisposable
    {
        ...
        internal Curtains_Scenes_Edit(ComponentMediator componentMediator, uint controlJoinId)
        {
        ...
        public void Dig_Reserved_Out1(Curtains_Scenes_EditBoolInputSigDelegate callback)
        {
        ...
        public void Scene0_CurrentName(Curtains_Scenes_EditStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Scene1_CurrentName(Curtains_Scenes_EditStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Scene2_CurrentName(Curtains_Scenes_EditStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "Curtains_Scenes_Edit", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
