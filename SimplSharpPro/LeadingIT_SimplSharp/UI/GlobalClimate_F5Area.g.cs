...
{
    public interface IGlobalClimate_F5Area
    {
        ...
        void IsSelected(GlobalClimate_F5AreaBoolInputSigDelegate callback);
        void PowerToggle_FB(GlobalClimate_F5AreaBoolInputSigDelegate callback);
        void Dig_Reserved_Out1(GlobalClimate_F5AreaBoolInputSigDelegate callback);
        void Dig_Reserved_Out2(GlobalClimate_F5AreaBoolInputSigDelegate callback);
        void Name(GlobalClimate_F5AreaStringInputSigDelegate callback);
        void AC_Status(GlobalClimate_F5AreaStringInputSigDelegate callback);
        void Setpoint_Value(GlobalClimate_F5AreaStringInputSigDelegate callback);
        void RoomTemp_Value(GlobalClimate_F5AreaStringInputSigDelegate callback);
        void RoomHum_Value(GlobalClimate_F5AreaStringInputSigDelegate callback);
        void Ser_Reserved_Out1(GlobalClimate_F5AreaStringInputSigDelegate callback);

    }

    public delegate void GlobalClimate_F5AreaBoolInputSigDelegate(BoolInputSig boolInputSig, IGlobalClimate_F5Area globalClimate_F5Area);
    public delegate void GlobalClimate_F5AreaStringInputSigDelegate(StringInputSig stringInputSig, IGlobalClimate_F5Area globalClimate_F5Area);

    internal class GlobalClimate_F5Area : IGlobalClimate_F5Area, IDisposable
    {
        ...
        internal GlobalClimate_F5Area(ComponentMediator componentMediator, uint controlJoinId)
        {
        ...
        public void IsSelected(GlobalClimate_F5AreaBoolInputSigDelegate callback)
        {
        ...
        public void PowerToggle_FB(GlobalClimate_F5AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out1(GlobalClimate_F5AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out2(GlobalClimate_F5AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Name(GlobalClimate_F5AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void AC_Status(GlobalClimate_F5AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Setpoint_Value(GlobalClimate_F5AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void RoomTemp_Value(GlobalClimate_F5AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void RoomHum_Value(GlobalClimate_F5AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Ser_Reserved_Out1(GlobalClimate_F5AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "GlobalClimate_F5Area", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
