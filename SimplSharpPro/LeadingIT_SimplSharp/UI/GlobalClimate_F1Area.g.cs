...
{
    public interface IGlobalClimate_F1Area
    {
        ...
        void IsSelected(GlobalClimate_F1AreaBoolInputSigDelegate callback);
        void PowerToggle_FB(GlobalClimate_F1AreaBoolInputSigDelegate callback);
        void Dig_Reserved_Out1(GlobalClimate_F1AreaBoolInputSigDelegate callback);
        void Dig_Reserved_Out2(GlobalClimate_F1AreaBoolInputSigDelegate callback);
        void Name(GlobalClimate_F1AreaStringInputSigDelegate callback);
        void AC_Status(GlobalClimate_F1AreaStringInputSigDelegate callback);
        void Setpoint_Value(GlobalClimate_F1AreaStringInputSigDelegate callback);
        void RoomTemp_Value(GlobalClimate_F1AreaStringInputSigDelegate callback);
        void RoomHum_Value(GlobalClimate_F1AreaStringInputSigDelegate callback);
        void Ser_Reserved_Out1(GlobalClimate_F1AreaStringInputSigDelegate callback);

    }

    public delegate void GlobalClimate_F1AreaBoolInputSigDelegate(BoolInputSig boolInputSig, IGlobalClimate_F1Area globalClimate_F1Area);
    public delegate void GlobalClimate_F1AreaStringInputSigDelegate(StringInputSig stringInputSig, IGlobalClimate_F1Area globalClimate_F1Area);

    internal class GlobalClimate_F1Area : IGlobalClimate_F1Area, IDisposable
    {
        ...
        internal GlobalClimate_F1Area(ComponentMediator componentMediator, uint controlJoinId)
        {
        ...
        public void IsSelected(GlobalClimate_F1AreaBoolInputSigDelegate callback)
        {
        ...
        public void PowerToggle_FB(GlobalClimate_F1AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out1(GlobalClimate_F1AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out2(GlobalClimate_F1AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Name(GlobalClimate_F1AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void AC_Status(GlobalClimate_F1AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Setpoint_Value(GlobalClimate_F1AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void RoomTemp_Value(GlobalClimate_F1AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void RoomHum_Value(GlobalClimate_F1AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Ser_Reserved_Out1(GlobalClimate_F1AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "GlobalClimate_F1Area", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
