...
{
    public interface ICurtains_Scenes
    {
        ...
        void Scene0_IsSelected(Curtains_ScenesBoolInputSigDelegate callback);
        void Scene1_IsSelected(Curtains_ScenesBoolInputSigDelegate callback);
        void Scene2_IsSelected(Curtains_ScenesBoolInputSigDelegate callback);
        void Dig_Reserved_Out1(Curtains_ScenesBoolInputSigDelegate callback);
        void Scene0_Name(Curtains_ScenesStringInputSigDelegate callback);
        void Scene1_Name(Curtains_ScenesStringInputSigDelegate callback);
        void Scene2_Name(Curtains_ScenesStringInputSigDelegate callback);

        App_Contract.ICurtains_Scenes_Edit Edit { get; }
    }

    public delegate void Curtains_ScenesBoolInputSigDelegate(BoolInputSig boolInputSig, ICurtains_Scenes curtains_Scenes);
    public delegate void Curtains_ScenesStringInputSigDelegate(StringInputSig stringInputSig, ICurtains_Scenes curtains_Scenes);

    internal class Curtains_Scenes : ICurtains_Scenes, IDisposable
    {
        ...
        internal Curtains_Scenes(ComponentMediator componentMediator, uint controlJoinId)
        {
        ...
        private void Initialize(uint controlJoinId)
        {
            ...
            Edit = new App_Contract.Curtains_Scenes_Edit(ComponentMediator, 142);
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((App_Contract.Curtains_Scenes_Edit)Edit).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((App_Contract.Curtains_Scenes_Edit)Edit).RemoveDevice(device);
        }
        ...
        public App_Contract.ICurtains_Scenes_Edit Edit { get; private set; }
        ...
        public void Scene0_IsSelected(Curtains_ScenesBoolInputSigDelegate callback)
        {
        ...
        public void Scene1_IsSelected(Curtains_ScenesBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Scene2_IsSelected(Curtains_ScenesBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out1(Curtains_ScenesBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Scene0_Name(Curtains_ScenesStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Scene1_Name(Curtains_ScenesStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Scene2_Name(Curtains_ScenesStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "Curtains_Scenes", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
        ...
        public void Dispose()
        {
            ...
            ((App_Contract.Curtains_Scenes_Edit)Edit).Dispose();
