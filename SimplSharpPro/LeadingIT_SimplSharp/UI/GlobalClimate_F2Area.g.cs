...
{
    public interface IGlobalClimate_F2Area
    {
        ...
        void IsSelected(GlobalClimate_F2AreaBoolInputSigDelegate callback);
        void PowerToggle_FB(GlobalClimate_F2AreaBoolInputSigDelegate callback);
        void Dig_Reserved_Out1(GlobalClimate_F2AreaBoolInputSigDelegate callback);
        void Dig_Reserved_Out2(GlobalClimate_F2AreaBoolInputSigDelegate callback);
        void Name(GlobalClimate_F2AreaStringInputSigDelegate callback);
        void AC_Status(GlobalClimate_F2AreaStringInputSigDelegate callback);
        void Setpoint_Value(GlobalClimate_F2AreaStringInputSigDelegate callback);
        void RoomTemp_Value(GlobalClimate_F2AreaStringInputSigDelegate callback);
        void RoomHum_Value(GlobalClimate_F2AreaStringInputSigDelegate callback);
        void Ser_Reserved_Out1(GlobalClimate_F2AreaStringInputSigDelegate callback);

    }

    public delegate void GlobalClimate_F2AreaBoolInputSigDelegate(BoolInputSig boolInputSig, IGlobalClimate_F2Area globalClimate_F2Area);
    public delegate void GlobalClimate_F2AreaStringInputSigDelegate(StringInputSig stringInputSig, IGlobalClimate_F2Area globalClimate_F2Area);

    internal class GlobalClimate_F2Area : IGlobalClimate_F2Area, IDisposable
    {
        ...
        internal GlobalClimate_F2Area(ComponentMediator componentMediator, uint controlJoinId)
        {
        ...
        public void IsSelected(GlobalClimate_F2AreaBoolInputSigDelegate callback)
        {
        ...
        public void PowerToggle_FB(GlobalClimate_F2AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out1(GlobalClimate_F2AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out2(GlobalClimate_F2AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Name(GlobalClimate_F2AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void AC_Status(GlobalClimate_F2AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Setpoint_Value(GlobalClimate_F2AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void RoomTemp_Value(GlobalClimate_F2AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void RoomHum_Value(GlobalClimate_F2AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Ser_Reserved_Out1(GlobalClimate_F2AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "GlobalClimate_F2Area", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
