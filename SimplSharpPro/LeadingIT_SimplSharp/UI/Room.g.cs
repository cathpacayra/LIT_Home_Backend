...
namespace App_Contract
{
    public interface IRoom
    {
        ...
        void IsSelected(RoomBoolInputSigDelegate callback);
        void Dig_Reserved_Out1(RoomBoolInputSigDelegate callback);
        void Name(RoomStringInputSigDelegate callback);
        void Ser_Reserved_Out1(RoomStringInputSigDelegate callback);
    ...
    internal class Room : IRoom, IDisposable
    {
        ...
        public void IsSelected(RoomBoolInputSigDelegate callback)
        {
        ...
        public void Dig_Reserved_Out1(RoomBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Name(RoomStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Ser_Reserved_Out1(RoomStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
