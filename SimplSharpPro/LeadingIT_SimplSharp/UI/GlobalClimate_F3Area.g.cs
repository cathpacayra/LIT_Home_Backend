...
{
    public interface IGlobalClimate_F3Area
    {
        ...
        void IsSelected(GlobalClimate_F3AreaBoolInputSigDelegate callback);
        void PowerToggle_FB(GlobalClimate_F3AreaBoolInputSigDelegate callback);
        void Dig_Reserved_Out1(GlobalClimate_F3AreaBoolInputSigDelegate callback);
        void Dig_Reserved_Out2(GlobalClimate_F3AreaBoolInputSigDelegate callback);
        void Name(GlobalClimate_F3AreaStringInputSigDelegate callback);
        void AC_Status(GlobalClimate_F3AreaStringInputSigDelegate callback);
        void Setpoint_Value(GlobalClimate_F3AreaStringInputSigDelegate callback);
        void RoomTemp_Value(GlobalClimate_F3AreaStringInputSigDelegate callback);
        void RoomHum_Value(GlobalClimate_F3AreaStringInputSigDelegate callback);
        void Ser_Reserved_Out1(GlobalClimate_F3AreaStringInputSigDelegate callback);

    }

    public delegate void GlobalClimate_F3AreaBoolInputSigDelegate(BoolInputSig boolInputSig, IGlobalClimate_F3Area globalClimate_F3Area);
    public delegate void GlobalClimate_F3AreaStringInputSigDelegate(StringInputSig stringInputSig, IGlobalClimate_F3Area globalClimate_F3Area);

    internal class GlobalClimate_F3Area : IGlobalClimate_F3Area, IDisposable
    {
        ...
        internal GlobalClimate_F3Area(ComponentMediator componentMediator, uint controlJoinId)
        {
        ...
        public void IsSelected(GlobalClimate_F3AreaBoolInputSigDelegate callback)
        {
        ...
        public void PowerToggle_FB(GlobalClimate_F3AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out1(GlobalClimate_F3AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Dig_Reserved_Out2(GlobalClimate_F3AreaBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Name(GlobalClimate_F3AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void AC_Status(GlobalClimate_F3AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Setpoint_Value(GlobalClimate_F3AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void RoomTemp_Value(GlobalClimate_F3AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void RoomHum_Value(GlobalClimate_F3AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        public void Ser_Reserved_Out1(GlobalClimate_F3AreaStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "GlobalClimate_F3Area", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
